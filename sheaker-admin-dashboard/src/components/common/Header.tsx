...
const Header: React.FC<AdminHeaderProps> = ({ setIsSidebarOpen, className }) => {
  ...
  const searchBarVariants = {
    closed: { width: "40px", transition: { duration: 0.3, ease: "easeInOut" } },
      ...
      <div className={cn("flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto")}>
        <div className="flex items-center gap-4">
          {/* <motion.button
            ...
            className="text-[#FB7E11] p-2 rounded-md hover:bg-[#FB7E11]/10 focus:outline-none focus:ring-2 focus:ring-[#0836C1] transition-all"
        ...
        <motion.div 
          className={cn(
            ...
            searchActive ? "flex-1 mx-4" : "w-auto"
          )}
          initial="closed"
        ...
        >
          <div className="relative w-full flex items-center">
            <motion.button
              ...
              className={cn(
                "absolute left-2 text-gray-400 hover:text-[#FB7E11] transition-colors",
                searchActive && "text-[#FB7E11]"
              )}
            >
              <FaSearch size={16} />
            </motion.button>
            <input
              ...
              placeholder="Search..."
              className={cn(
                "bg-[#2D2D2D] text-white rounded-full py-2 pl-10 pr-4 w-full focus:outline-none focus:ring-2 focus:ring-[#0836C1] transition-all",
                !searchActive && "w-10 cursor-pointer"
              )}
              style={{ 
                opacity: searchActive ? 1 : 0.8,
